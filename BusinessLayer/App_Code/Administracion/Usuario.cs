  ...
  /*------------FIN---------------- CASO DE USO SALVAR Y RESTAURAR DATOS    ---------------FIN----------------------*/
   ...
   /*------------INICIO---------------- CASO DE USO GESTIONAR NOTIFICACION---------------INICIO----------------------*/
    ...
    public DataSet Datos_Mtarj(string tarjeta)
    {
        ...
        try
        {
            ds = Handler.Datos_MTARJ(tarjeta);
        }
        catch (Exception)
        {
    ...
    {
        //string validado;
        DataSet dresultado = new DataSet();
        try
        {
            dresultado = Handler.Datos_PAN(pan, tb, numideper, codtipid, codpais, out mensaje_error, out cod_error);
        }
        catch (Exception)
        {
    ...
    public DataSet GuardarInfoPAN_Activacion(string pan, string num_ideper, string codigo_encrip, string estado, out string mensaje, out int cod_error)
    {
        ...
        try
        {
            dresultado = Handler.GuardarInfoPAN_Activacion(pan, num_ideper, codigo_encrip, estado, out mensaje, out cod_error);
        }
        catch (Exception)
        {
    ...
    public DataSet Importe_Conv_USD_to_CUPon(string moneda_origen, string moneda_destino, DateTime fecha_bt, float importe_acreditar)
    {
        ...
        try
        {
            ...
            try
            {
                dresultado = Handler.Importe_Conv_USD_to_CUPon(moneda_origen, moneda_destino, fecha_bt, importe_acreditar);
            }
            catch (Exception)
            {
    ...
    public DataSet Get_Info_Cuenta_Transferencia(string num_cuenta)
    {
        ...
        try
        {
            ds = Handler.Get_Info_Cuenta_Transferencia(num_cuenta);
        }
        catch (Exception)
        {
    ...
    public DataSet TarjetasMagneticas_Cliente(string numideper, string codtipi, string idpais)
    {
        ...
        try
        {
            ds = Handler.TarjetasMagneticas_Cliente(numideper, codtipi, idpais);
        }
        catch (Exception)
        {
