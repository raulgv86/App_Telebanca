...
<body style="margin: 0px; clip: rect(0px 0px 0px 0px); font-size: 12pt; text-align: left;" onload="MM_preloadImages('Imagenes/Botones_Barra_Estado/temporal.png','Imagenes/Botones_Barra_Estado/bot_peque&ntilde;o_ sobre.png')">
    <form id="form1" runat="server">                
        <div style="margin: 0px; width: 100px; clip: rect(0px 0px 0px 0px); height: 614px; text-align: left;">
                <%--<table style="width: 794px">--%>
              <table style="width: 950px" align="left">
                <tr>
                    <td colspan="4">
                        <img id="IMG1" src="Images/Imagenes/telebanca_portada.png" style="width: 950px; height: 110px" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <iframe frameborder="0" width="1%" height="1px" src="HTML/saludo.htm" style="width: 127px; height: 30px;margin-top:-10px; font-weight: bold;" scrolling="no"></iframe>
                    ...
                    <td colspan="2" style="text-align: left; font-weight: bold;">
                     <iframe frameborder="0" width="100%" height="25px" src="HTML/fecha.htm" style="width: 69%; height: 30px; margin-top:-10px;font-weight: bold;" scrolling="no"></iframe>
                    ...
                    OnClick="ImageButton3_Click" Width="140px" />&nbsp;
                        <asp:ImageButton ID="ImageButton7" runat="server" Height="29px" ImageUrl="~/Images/Imagenes/tele0.png"
                            OnClick="ImageButton7_Click" ToolTip="Conectar Cliente" Width="70px" />&nbsp;<asp:ImageButton
                                ...
                                OnClick="ImageButton8_Click" ToolTip="Desconectar Cliente" Visible="False" Width="70px" />
                        <%--<asp:Label ID="Label_TarjetaBT_Autenticada" runat="server" Text="95-0000-0000" Font-Bold="True" ForeColor="#CC3300"></asp:Label>--%>
                    </td>
