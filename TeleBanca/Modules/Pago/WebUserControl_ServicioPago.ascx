...
<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxDataView" TagPrefix="dx" %><%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxGridView" TagPrefix="dx" %><%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxLoadingPanel" TagPrefix="dx" %><%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dx" %><%@ Register Assembly="msgBox" Namespace="BunnyBear" TagPrefix="cc1" %><%@ Register assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxCallback" tagprefix="dx" %><style type="text/css">
    .auto-style1 {
        height: 25px;
    }
    ...
    </style><script type="text/javascript" src="../../Scripts/JScript.js">
    </script><%--<table width="800">--%><table width="950px">
        <tbody>
            <tr>
                <td valign="top" align="left" style="height: 22457px; width: 204px;">
                    <asp:Menu ID="Menu1" runat="server"
                        ...
                        <StaticHoverStyle BackColor="#FFFFCC" BorderColor="#FFFFCC" />
                            ...
                            <td colspan="2" style="width: 628px; height: 22457px; text-align: center;" valign="top">
                                <dx:ASPxLoadingPanel ID="ASPxLoadingPanel1" runat="server" ClientInstanceName="loading" Text="Esperando..."></dx:ASPxLoadingPanel>
                                <dx:ASPxCallback ID="ASPxCallback1" runat="server">
                                    <ClientSideEvents CallbackComplete="function(s, e) {
	loading.hide();
	loading_gridviewAmort.hide();
}" />
                                </dx:ASPxCallback>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                        ...
                                        text-align: center">
                            <table cellpadding="0" cellspacing="0" style="width: 300px" align="center">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="padding-bottom: 4px; width: 43px; padding-top: 3px; height: 23px; text-align: center;">
                                        <asp:Button ID="Button64" runat="server" Text="Aceptar" OnClick="Button64_Click" CausesValidation="False" Font-Names="Calibri" Width="60px" ValidationGroup="1" />                                        
                                    </td>
                                    <td align="center" style="padding-bottom: 4px; width: 43px; padding-top: 3px; height: 23px; text-align: center;">
                                        <asp:Button ID="Button65" runat="server" CausesValidation="False" Font-Names="Calibri" OnClick="Button65_Click" Text="Cancelar" ValidationGroup="1" Width="60px" />
                                    </td>
                                        
                                    <caption>
                                        
                                        <tr>
                                            <td align="center" style="padding-bottom: 4px; width: 43px; padding-top: 3px; height: 23px; text-align: center;"></td>
                                        </tr>
                                    </caption>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                        ...
                                        <asp:Button ID="Button10" runat="server" Text="Aceptar" OnClick="Button10_Click" Enabled="False" Font-Names="Calibri" Font-Size="11pt" Width="70px" />
                                            ...
                                            <tr>
                                                <td style="background-color: darkslategray; text-align: left">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <table align="center">
                                        ...
                                        <tr>
                                            <td style="text-align: center">
                                                <strong><span style="font-size: 14pt; font-family: Calibri"></span></strong></td>
                                            <td style="text-align: center">
                                            <asp:Button ID="Button13" runat="server" OnClick="Button13_Click1" Text="Si" Width="70px" OnClientClick="DesactivarBoton('WebUserControl_ServicioPago1_', 'Button13');" Font-Bold="True" Font-Names="Calibri" Font-Size="11pt" />
                                            <%--<dx:ASPxButton ID="Button13" runat="server" OnClick="Button13_Click1" Text="Si" Width="70px">
                                                <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                                </dx:ASPxButton>--%>
                                             &nbsp;                                                
                                            <asp:Button ID="Button18" runat="server" Text="No" Width="70px" OnClick="Button18_Click" Font-Bold="True" Font-Names="Calibri" Font-Size="11pt" />
                                            <%--<dx:ASPxButton ID="Button18" runat="server" Text="No" Width="70px" OnClick="Button18_Click"></dx:ASPxButton>--%>
                                            </td>
                                            <td style="text-align: center">
                                            </td>
                                        </tr>
                                ...
                                <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                        ...
                                        text-align: center"><table cellpadding="0" cellspacing="0" style="width: 98%">
                                            ...
                                            <tr style="font-family: Times New Roman">
                                                ...
                                                <td align="left" colspan="3" style="padding-left: 4px; padding-top: 5px; height: 12px">
                                ...
                                <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                    ...
                                    <table align="center">
                                        ...
                                        <asp:RadioButtonList ID="RadioButtonList6" runat="server"  Width="166px" Font-Names="Calibri" Font-Size="14pt" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList6_SelectedIndexChanged2" ForeColor="Teal">
                                            ...
                                            <asp:ListItem Enabled="False">Solicitar Tarjeta</asp:ListItem>
                                        ...
                                        <table align="center">
                                            <tr>
                                                <td rowspan="1" style="text-align: center">
                                                    <strong><span style="font-size: 14pt; font-family: Calibri">Nombre del Servicio</span></strong></td>
                                                <td rowspan="1" style="font-size: 14pt; text-align: center">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center; height: 25px;">
                                                ...
                                                <td style="text-align: center; font-size: 14pt; height: 25px;">
                                                ...
                                                <td style="text-align: left;">
                                                    <strong><span style="font-size: 14pt"><span style="font-family: Calibri">Días entre<span> Descargas &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span></span></span></strong>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox21"
                                                            ErrorMessage="*"></asp:RequiredFieldValidator></td>
                                                <td style="text-align: center">
                                                    <%--<dx:ASPxButton ID="BtnDescFTP" runat="server" Text="Descargar Ahora" OnClick="BtnDescFTP_Click" Width="127px" Font-Names="Calibri" Font-Size="11pt">
                                                        <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                                    </dx:ASPxButton>--%>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <asp:Button ID="Button33" runat="server" Text="Aceptar" OnClick="Button33_Click" CausesValidation="False" Font-Names="Calibri" Font-Size="11pt" Width="70px" OnClientClick="return confirm(' ¿Confirma que desea guardar la informacion? ');" />
                                    ...
                                    <tr>
                                        <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                            ...
                                            <table align="center">
                                                ...
                                                <tr>
                                                    <td style="text-align: center;">
                                                        <asp:Button ID="Button44" runat="server" Text="Aceptar" Width="65px" OnClick="Button44_Click1" Font-Names="Calibri" Font-Size="11pt" OnClientClick="return confirm('¿Desea guardar la reclamacion?');" />&nbsp;
                                        ...
                                        <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                            ...
                                            <table align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 97px">
                                                        <asp:Button ID="Button67" runat="server" OnClick="Button67_Click" Text="Aceptar" Width="65px" Font-Names="Calibri" Font-Size="11pt" />
                                                        <%--<dx:ASPxButton ID="Button67" runat="server" OnClick="Button67_Click" Text="Aceptar" Width="65px"></dx:ASPxButton>--%>
                                                    </td>
                                                    <td style="width: 80px">
                                                        <asp:Button ID="Button77" runat="server" Text="Cancelar" OnClick="Button77_Click" Font-Names="Calibri" Font-Size="11pt" Width="65px" />
                                                        <%--<dx:ASPxButton ID="Button77" runat="server" Text="Cancelar" OnClick="Button77_Click" Width="65px"></dx:ASPxButton>--%>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                        ...
                                        <asp:TextBox ID="TextBox57" runat="server" Width="170px" Font-Names="Calibri" Font-Size="10pt"></asp:TextBox></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>                                                    
                                                    <asp:DropDownList ID="DropDownList10" runat="server" Width="170px" Font-Names="Calibri" Font-Size="10pt"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                        ...
                                        <table align="center">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <asp:Button ID="Button99" runat="server" Enabled="False" Text="Sí" OnClick="Button99_Click" CausesValidation="False" Font-Names="Calibri" Font-Size="11pt" Width="65px" Font-Bold="True" ForeColor="Black" />
                                                    <%--<dx:ASPxButton ID="Button99" runat="server" Enabled="False" Text="Sí" OnClick="Button99_Click" CausesValidation="False" Width="65px">
                                                        <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                                    </dx:ASPxButton>--%>    
                                                ...
                                                <td style="text-align: center">
                                                    <span style="font-family: Calibri">
                                                    <asp:Button ID="Button101" runat="server" OnClick="Button101_Click" Text="No" CausesValidation="False" Font-Names="Calibri" Font-Size="11pt" Width="65px" Font-Bold="True" ForeColor="Black" />
                                                        <%--<dx:ASPxButton ID="Button101" runat="server" OnClick="Button101_Click" Text="No" CausesValidation="False" Width="65px"></dx:ASPxButton>--%>
                                                    </span>
                                                ...
                                                <td colspan="4" style="text-align: center">
                                                    <asp:Panel ID="Panel9" runat="server" Height="20px" Width="500px">
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TeleBancaConnectionString %>"
                                                            SelectCommand="SELECT DISTINCT LTRIM(RTRIM(articulo)) AS articulo FROM TLB_Multas ORDER BY articulo "
                                                            ></asp:SqlDataSource>
                        ...
                        <asp:View ID="View40" runat="server" OnActivate="View40_Activate">
                            <table width="100%" align="center">
                                ...
                                <tr>
                                    <td style="border: 2px solid #d8d787; padding-right: 5px; padding-left: 15px; padding-bottom: 14px; width: 538px;
                                        padding-top: 14px; height: 21px; text-align: center" valign="top">
                                        <span style="font-size: 10pt;"><span><strong style="text-align: center"><span style="font-size: 14pt; font-family: Calibri;">
                                        </span>
                                            <br />
                                                    ...
                                                    style="font-family: Calibri"><span
                                                        ...
                                                        <table style="font-size: 14pt; text-align: center" align="center">
                                                            <tr>
                                                                <td colspan="3">
                                                    ...
                                                    <tr>
                                                        <td colspan="5" style="text-align: center">
                                                            <span style="font-size: 14pt; font-family: Calibri"><strong style="color: teal">Tarjeta No: </strong></span>
                                                                ...
                                                                <asp:Button ID="Button104" runat="server" OnClick="Button104_Click" Text="Buscar" />
                                                                <%--<dx:ASPxButton ID="Button104" runat="server" OnClick="Button104_Click" Text="Buscar">
                                                                    <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                                            </dx:ASPxButton>--%>
                                                ...
                                                <table align="center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            ...
                                                            <%--<dx:ASPxButton ID="Button107" runat="server" OnClick="Button107_Click" Text="Buscar" Width="70px">
                                                                <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                                            </dx:ASPxButton>--%>
                                                            &nbsp;
                                                            <asp:Button ID="Button109" runat="server" OnClick="Button109_Click" Text="Cancelar" Font-Names="Calibri" Font-Size="11pt" Width="70px" />
                                                            <%--<dx:ASPxButton ID="Button109" runat="server" OnClick="Button109_Click" Text="Cancelar" Width="70px"></dx:ASPxButton>--%>
                                                        </td>
                                                        <td style="width: 100px">
                                                        </td>
                                                        <td style="width: 60px">
                                                ...
                                                <asp:Button ID="Button108" runat="server" OnClick="Button108_Click" Text="Reversar" Font-Names="Calibri" Font-Size="11pt" Width="80px" OnClientClick="return confirm('¿Realmente desea reversar la Operación?');" /></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" id="Table4" onclick="return TABLE2_onclick()">
                                        ...
                                        text-align: center">
                                                <table align="center">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Button ID="Button110" runat="server" Font-Names="Calibri" Font-Size="11pt" OnClick="Button110_Click" Text="Aceptar" Width="65px" />
                                                            &nbsp;
                                                            <asp:Button ID="Button111" runat="server" Font-Names="Calibri" Font-Size="11pt" OnClick="Button106_Click" Text="Cancelar" Width="65px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" id="Table6" onclick="return TABLE2_onclick()">
                                        ...
                                        <tr>
                                            <td align="center" style="border: 2px solid #d8d787; padding: 14px 17px; position: static;
                                        ">
                                                <br />
                                                <table>
                                                    <tr>
                                ...
                                <asp:View ID="View49" runat="server" OnActivate="View49_Activate">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="font-weight: bold; font-size: 12pt; width: 613px; font-family: Verdana;
                                        height: 21px; background-color: darkslategray">
                                        ...
                                        text-align: center">
                                                ...
                                                <asp:TextBox ID="TextBox61" runat="server" Width="162px" Font-Names="Calibri"></asp:TextBox></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Button ID="Button116" runat="server" Font-Names="Calibri" Font-Size="11pt" OnClick="Button116_Click" Text="Aceptar" Width="65px" />
                                                            &nbsp;
                                                            <asp:Button ID="Button117" runat="server" Font-Names="Calibri" Font-Size="11pt" OnClick="Button87_Click1" Text="Cancelar" Width="65px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                                &nbsp;&nbsp;</td>
                        ...
                        <asp:View ID="View53" runat="server" OnActivate="View53_Activate">
                            <div style="text-align: center">
                                <table style="width: 600px" align="center">
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align: center">
                                            <asp:Label ID="Label176" runat="server" Enabled="False" Font-Bold="True" Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="text-align: center">
                                    ...
                                    <tr>
                                        <td style="text-align: right" align="right">
                                            <asp:Button ID="Button98" runat="server" Text="Sí" Width="60px" OnClick="Button98_Click2" />
                                            <%--<dx:ASPxButton ID="Button98" runat="server" Text="Sí" Width="60px" OnClick="Button98_Click2">
                                                <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                            </dx:ASPxButton>--%>
                                        ...
                                        <td style="text-align: left" align="left">
                                            <asp:Button ID="Button130" runat="server" Text="No" Width="60px" OnClick="Button130_Click" />
                                            <%--<dx:ASPxButton ID="Button130" runat="server" Text="No" Width="60px" OnClick="Button130_Click"></dx:ASPxButton>--%>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <asp:View ID="View54" runat="server" OnActivate="View54_Activate">
                            <div style="text-align: center">
                                <table style="width: 600px" align="center">
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align: center">
                                            <asp:Label ID="Label177" runat="server" Enabled="False" Font-Bold="True" Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100px">
                                    ...
                                    <tr>
                                        <td style="text-align: right" align="right">
                                            <asp:Button ID="Button131" runat="server" Text="Sí" Width="60px" OnClick="Button131_Click" />
                                            <%--<dx:ASPxButton ID="Button131" runat="server" Text="Si" Width="60px" OnClick="Button131_Click">
                                                <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                            </dx:ASPxButton>--%>
                                        ...
                                        <td style="width: 100px; text-align: left">
                                            <asp:Button ID="Button132" runat="server" Text="No" Width="60px" OnClick="Button132_Click" />
                                            <%--<dx:ASPxButton ID="Button132" runat="server" Text="No" Width="60px" OnClick="Button132_Click"></dx:ASPxButton>--%>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="background-color: darkslategray">
                            ...
                            <table style="width: 600px" align="center">
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" rowspan="4" style="text-align: left" valign="top">
                                        <asp:RadioButtonList ID="RadioButtonList14" runat="server" Font-Names="Calibri" OnSelectedIndexChanged="RadioButtonList14_SelectedIndexChanged" AutoPostBack="True" Font-Bold="True" Font-Size="Small" ForeColor="#FF8000">
                                            ...
                                            <asp:ListItem Value="USD">Asociada a BT en USD</asp:ListItem>
                                        </asp:RadioButtonList></td>
                                </tr>
                                <tr>
                                    <td colspan="1" style="width: 212px; text-align: center">
                                ...
                                <tr>
                                    <td colspan="4" style="text-align: center; height: 26px;">
                                        <asp:Button ID="Button134" runat="server" Text="Sí" Width="60px" OnClick="Button134_Click" Enabled="False" ValidationGroup="1" />
                                        <%--<dx:ASPxButton ID="Button134" runat="server" Text="Si" Width="60px" OnClick="Button134_Click" Enabled="False" ValidationGroup="1">
                                            <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                        </dx:ASPxButton>--%>
                                        &nbsp;
                                        <asp:Button ID="Button135" runat="server" Text="No" Width="60px" OnClick="Button135_Click" />
                                        <%--<dx:ASPxButton ID="Button135" runat="server" Text="No" Width="60px" OnClick="Button135_Click"></dx:ASPxButton>--%>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <asp:View ID="View57" runat="server" OnActivate="View57_Activate">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">                                        
                                        <asp:Button ID="Button137" runat="server" Text="Sí" Width="60px" OnClick="Button137_Click" />
                                        <%--<dx:ASPxButton ID="Button137" runat="server" Text="Si" Width="60px" OnClick="Button137_Click">
                                            <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                        </dx:ASPxButton> --%>                 
                                    ...
                                    <td style="text-align: left">
                                        <asp:Button ID="Button138" runat="server" Text="No" Width="60px" OnClick="Button138_Click" BackColor="White" />
                                        <%--<dx:ASPxButton ID="Button138" runat="server" Text="No" Width="60px" OnClick="Button138_Click"></dx:ASPxButton>--%>
                                    </td>
                                    <td style="width: 100px">
                                    </td>                                    
                                </tr>
                        ...
                        <asp:View ID="View58" runat="server" OnActivate="View58_Activate">
                           <%--<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                ...
                                <table style="width: 600px" align="center">
                                <tr>
                                    <td style="height: 21px; background-color: darkslategray; text-align: center;" colspan="3">
                                        <asp:Label ID="Label168" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="AMORTIZACIÓN DE DEUDAS" ToolTip="El tipo o tasa de cambio entre dos divisas es la tasa o relación de proporción que existe entre el valor de una y la otra. Dicha tasa es un indicador que expresa cuántas unidades de una divisa se necesitan para obtener una unidad de la otra."></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <asp:Label ID="Label169" runat="server" Font-Bold="True" Text="Carné de Identidad"></asp:Label>
                                        </td>
                                </tr>
                                <tr>
                                    <td style="text-align: center;" colspan="3">
                                        <asp:TextBox ID="TextBox74" runat="server" MaxLength="11" onkeyup="AsignarIrSiguiente('WebUserControl_ServicioPago1_', 'TextBox74',11,'Button144');" Width="130px" OnTextChanged="TextBox74_TextChanged"></asp:TextBox>                                                                                
                                    </td>
                                </tr>
                                         <tr>
                                             <td colspan="3" style="text-align: center;">
                                                 <asp:Button ID="Button144" runat="server" Text="Buscar" Width="80px" OnClick="Button144_Click" />
                                                 <%--<dx:ASPxButton ID="Button144" runat="server" Text="Buscar" Width="80px" OnClick="Button144_Click">
                                            <ClientSideEvents Click="function(s, e) {
loading.Show();	
}" />
                                        </dx:ASPxButton>--%>
                                        &nbsp; <asp:Button ID="Button145" runat="server" OnClick="Button142_Click" Text="Cancelar" />
                                        <%--<dx:ASPxButton ID="Button145" runat="server" Text="Cancelar" Width="80px" OnClick="Button142_Click"></dx:ASPxButton>--%>
                                             </td>
                                         </tr>
                                         <tr>
                                         ...
                                         <tr id="fila_label_notificacion" runat="server">
                                             <td style="width: 100px">&nbsp;</td>
                                             <td style="text-align: center">
                                                 <asp:Label ID="Label175" runat="server" Font-Bold="True" ForeColor="Red" Text="Label_Notificacion_SinCredito" Visible="False"></asp:Label>
                                             </td>
                                             <td style="width: 100px">
                                                 <dx:ASPxLoadingPanel ID="ASPxLoadingPanel_GridView" runat="server" ClientInstanceName="loading_gridviewAmort" ContainerElementID="GridView11">
                                                 </dx:ASPxLoadingPanel>
                                             </td>
                                         </tr>
                                         <tr id="fila_label_creditos_asociados" runat="server">
                                             <td colspan="3" style="background-color: darkslategray; text-align: center">
                                                 <asp:Label ID="Label170" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="CREDITOS ASOCIADOS" ToolTip="Cuentas Estandarizadas de cada credito | Proposito del Credito | Articulo (si lo lleva) | Caracteristica de la persona asociada al credito | Estado en que se encuentra el credito"></asp:Label>
                                             </td>
                                         </tr>
                                <tr>
                                    <td colspan="3" dir="auto">
                                        <%--<asp:GridView ID="GridView11" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="None" OnSelectedIndexChanged="GridView11_SelectedIndexChanged" Visible="False" Width="600px">
                                        ...
                                        <dx:ASPxGridView ID="ASPxGridView3" runat="server" Visible="False" Width="100%" OnHtmlDataCellPrepared="ASPxGridView3_HtmlDataCellPrepared" KeyFieldName="cuenta" OnAfterPerformCallback="ASPxGridView3_AfterPerformCallback" OnFocusedRowChanged="ASPxGridView3_FocusedRowChanged" >
                                ...
                                <tr>
                                    <td colspan="3" text-align: center">
                                        <asp:Button ID="ASPxButton7" runat="server" OnClick="GridView11_SelectedIndexChanged" Width="120px" Text="VER DETALLES" Visible="False" Enabled="False" />
                                        <%--<dx:ASPxButton ID="ASPxButton7" runat="server" OnClick="GridView11_SelectedIndexChanged" Width="120px" Text="VER DETALLES" Visible="False" Enabled="False">
                                            <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                        </dx:ASPxButton>--%>
                                         ...
                                         <tr id="fila_verde1" runat="server">
                                             <td colspan="3" style="background-color: darkslategray; text-align: center">&nbsp;</td>
                                        </tr>
                                         <tr id="fila_label_notificacion2" runat="server">
                                             <td colspan="3">
                                                 <asp:Label ID="Label174" runat="server" Font-Bold="True" ForeColor="Red" Text="Label_Notificacion" Visible="False"></asp:Label>
                                                 <%--<asp:Button ID="Button142" runat="server" Text="No" Width="60px" />--%>&nbsp;</td>
                                        </tr>
                                         <tr id="fila_verde_info_cred" runat="server" style="height:45px">
                                             <td colspan="3" style="background-color: darkslategray; text-align: center">
                                                 <asp:Label ID="Label183" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="INFORMACION DETALLADA DEL CREDITO" ToolTip="Toda la informacion del credito teniendo en cuenta los meses que pretende amortizar"></asp:Label>
                                                 <br />
                                                 <dx:ASPxLabel ID="ASPxLabel3" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="White" Text="CUENTA_ESTANDARIZADA" Visible="False">
                                                 </dx:ASPxLabel>
                                             </td>
                                         </tr>                                    
                                <tr>
                                    <td colspan="3" style="background-color: darkslategray; text-align: center">
                                        <asp:DetailsView ID="DetailsView2" runat="server" CellPadding="4" Height="50px" Visible="False" Width="600px" ForeColor="#333333" GridLines="None">
                                            <AlternatingRowStyle HorizontalAlign="Left" VerticalAlign="Middle" BackColor="White" />
                                            <CommandRowStyle BackColor="#D1DDF1" Font-Bold="True" />
                                            <EditRowStyle BackColor="#2461BF" />
                                            <FieldHeaderStyle BackColor="#DEE8F5" Font-Bold="True" />
                                            <FooterStyle BackColor="#106d72" ForeColor="White" Font-Bold="True" />
                                            <HeaderStyle BackColor="#106d72" Font-Bold="True" ForeColor="White" />
                                            <PagerStyle BackColor="#106d72" ForeColor="White" HorizontalAlign="Center" />
                                            <RowStyle Font-Size="Small" HorizontalAlign="Left" VerticalAlign="Middle" BackColor="#EFF3FB" />
                                        </asp:DetailsView>

                                        <%--<asp:DetailsView ID="DetailsView3" runat="server" Height="50px" Visible="False" Width="600px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                                            
                                            <EditRowStyle BackColor="#669999" Font-Bold="True" ForeColor="White" HorizontalAlign="Left" />
                                ...
                                <tr id="fila_verde3" runat="server">
                                    <td style="background-color: darkslategray;" colspan="3" class="auto-style1">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <asp:Label ID="Label173" runat="server" Font-Bold="True" Text="Deuda(Meses)" Visible="False"></asp:Label>
                                        &nbsp;
                                        <asp:TextBox ID="TextBox77" runat="server" MaxLength="3" Visible="False" Width="30px"></asp:TextBox>
                                        &nbsp;
                                        <asp:Button ID="Button143" runat="server" OnClick="Button143_Click" Text="Procesar" Visible="False" />
                                        <%--<dx:ASPxButton ID="Button143" runat="server" OnClick="Button143_Click" Text="Procesar">
                                            <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                        </dx:ASPxButton>--%>
                                         ...
                                         <tr id="fila_verde4" runat="server">
                                             <td style="background-color: darkslategray;" colspan="3">&nbsp;</td>
                                         </tr>
                                         <tr id="fila_label_efectuar_pago" runat="server">
                                             <td colspan="3">
                                                 <asp:Label ID="Label172" runat="server" Font-Bold="True" Text="Efectuar Pago" Visible="False"></asp:Label>
                                             </td>
                                         </tr>
                                
                                         <tr>
                                    <td colspan="3">
                                        <asp:Button ID="Button141" runat="server" Text="Si" Width="60px" OnClick="ASPxButton1_Click" Enabled="true" OnClientClick="return confirm('¿Desea confirmar la Amortizacion?');" />
                                        <%--<dx:ASPxButton ID="Button141" runat="server" OnClick="ASPxButton1_Click" Text="Si" Width="60px">
                                            <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                        </dx:ASPxButton>--%>
                                        &nbsp;
                                        <asp:Button ID="Button142" runat="server" Text="No" Width="60px" OnClick="Button142_Click" Visible="true" />
                                        <%--<dx:ASPxButton ID="Button142" runat="server" OnClick="Button142_Click" Text="No" Visible="true" Width="60px"></dx:ASPxButton>--%>
                                    </td>
                                </tr>
                                <tr id="fila_verde5" runat="server">
                                    <td colspan="3" style="background-color: darkslategray">
                                    </td>
                                </tr>
                                ...
                                <%--<tr>
                                    ...
                                    <td style="text-align: right">
                                        <dx:ASPxButton ID="Button141" runat="server" Text="Sí" Width="60px" OnClick="Button141_Click" Enabled="false"></dx:ASPxButton>                             
                                    </td>
                                    <td style="text-align: left">
                                        <dx:ASPxButton ID="Button142" runat="server" Text="No" Width="60px" OnClick="Button142_Click" Visible="true"></dx:ASPxButton>
                                    </td>
                                    <td style="width: 100px">
                                    </td>
                                </tr>
                        ...
                        <asp:View ID="View59" runat="server" OnActivate="Active_59_UltimosMov">
                        <table style="width: 100%" align="center">
                            <tr>
                                <td colspan="4" style="background-color: darkslategray; text-align: center">
                                    <asp:Label ID="Label178" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="ULTIMOS MOVIMIENTOS" ToolTip="Ultimos 10 Movimientos de la cuenta seleccionada y a su vez asociada a la tarjeta BT. Puede seleccionar los ultimos movimientos por cada servicio o en general usando dicha cuenta CUP o CUC"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center"></td>
                                <td style="text-align: center" class="auto-style1" colspan="2">
                                    <asp:Label ID="Label179" runat="server" Font-Bold="True" Text="SELECCIONAR MONEDA"></asp:Label>
                                </td>
                                <td style="text-align: center"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: left" class="auto-style1" colspan="2">
                                    <asp:RadioButtonList ID="RadioButtonList19" runat="server" AutoPostBack="True" Enabled="False" Font-Bold="True" Font-Names="Calibri" Font-Size="Large" ForeColor="#FF8000" RepeatDirection="Horizontal" OnSelectedIndexChanged="RadioButtonList19_SelectedIndexChanged">
                                    </asp:RadioButtonList>
                                </td>
                                <td style="text-align: center"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style1" style="text-align: center" colspan="2">
                                    <asp:Label ID="Label180" runat="server" Font-Bold="True" Text="SELECCIONAR SERVICIO"></asp:Label>
                                </td>
                                <td style="text-align: center">&nbsp;</td>
                            </tr>
                            <tr>
                                <td style="text-align: center">&nbsp;</td>
                                <td class="auto-style1" style="text-align: center" colspan="2">
                                    <%--<dx:ASPxComboBox ID="ASPxComboBox1" runat="server" HorizontalAlign="Center">
                                        </dx:ASPxComboBox>--%>
                                    <asp:DropDownList ID="DropDownList19" runat="server" Width="170px" Enabled="False">
                            ...
                            <tr>
                                <td style="text-align: center"></td>
                                <td style="text-align: center" class="auto-style1" colspan="2">
                                    <asp:Button ID="ASPxButton1" runat="server" Text="CONSULTAR" OnClick="ASPxButton1_Click1" Enabled="False" />
                                    <%--<dx:ASPxButton ID="ASPxButton1" runat="server" Text="CONSULTAR" OnClick="ASPxButton1_Click1" Enabled="False">
                                        <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                    </dx:ASPxButton>--%>
                                    &nbsp;
                                    <asp:Button ID="ASPxButton4" runat="server" Text="CANCELAR" OnClick="ASPxButton4_Click" />
                                    <%--<dx:ASPxButton ID="ASPxButton4" runat="server" Text="CANCELAR" OnClick="ASPxButton4_Click"></dx:ASPxButton>--%>
                                </td>
                                <td style="text-align: center"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="Ref Contable" Style="text-align: justify" Width="100%">
                                        <SettingsBehavior AllowSort="False" />
                                        <SettingsPager EllipsisMode="None" ShowDisabledButtons="False" ShowNumericButtons="False">
                            ...
                            <tr>
                                <td colspan="4" style="background-color: darkslategray"></td>
                            </tr>
                        </table>
                    </asp:View>
                    <asp:View ID="View60" runat="server" OnActivate="View60_Activate">
                        <table style="width: 100%;">
                            <tr>
                                <td style="background-color: darkslategray; text-align: center">
                                    <asp:Label ID="Label182" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="CANCELAR REGISTRO BANCA-MOVIL" ToolTip="Cancela el Registro que tiene hecho el cliente por Transfermovil asociado a la tarjeta telebanca. Pasando el numero de movil se cancelará el registro"></asp:Label>
                                </td>
                            </tr>                            
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Bold="True" Font-Size="Medium" Text="NUMERO MOVIL">
                                    </dx:ASPxLabel>                                    
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:TextBox ID="TextBox79" runat="server" MaxLength="10" Width="120px"></asp:TextBox>                                                             
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxButton ID="ASPxButton2" runat="server" Text="ACEPTAR" OnClick="ASPxButton2_Click">
                                        <ClientSideEvents Click="function(s, e) {
	loading.Show();
}" />
                                    </dx:ASPxButton>
                                    &nbsp;
                                    <dx:ASPxButton ID="ASPxButton3" runat="server" Text="CANCELAR" OnClick="ASPxButton3_Click">
                    ...
                    <asp:View ID="View61" runat="server" OnActivate="View61_Activate">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td style="font-weight: bold; font-size: 12pt; width: 613px; font-family: Verdana;
                                        height: 21px; background-color: darkslategray">
                                                <asp:Label ID="Label181" runat="server" Font-Names="Calibri" Font-Size="14pt" ForeColor="#FFFFCC"
                                                    Text="Reporte Consulta Ultimos Movimientos"></asp:Label></td>
                                        </tr>
                                        ...
                                        text-align: center">
                                                ...
                                                <table align="center" style="width: 375px">
                                                    <tr>
                                                        <td colspan="2">
                                                            <span style="font-size: 14pt; font-family: Calibri"><strong style="color: teal">Operador: </strong></span>
                                                <asp:TextBox ID="TextBox81" runat="server" Width="162px" Font-Names="Calibri"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Panel ID="Panel10" runat="server" Height="25px" Width="100%">
                                                            </asp:Panel>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Calendar ID="Calendar20" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar15_DayRender" ShowGridLines="True" Width="180px">
                                                                <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                                <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                                <SelectorStyle BackColor="#FFCC66" />
                                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                        ...
                                                        <td>
                                                            <asp:Calendar ID="Calendar21" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar16_DayRender" ShowGridLines="True" Width="180px">
                                                                <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                                <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                                <SelectorStyle BackColor="#FFCC66" />
                                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Button ID="Button147" runat="server" Font-Names="Calibri" Font-Size="11pt" Text="Aceptar" Width="65px" OnClick="Button147_Click" />
                                                            &nbsp;
                                                            <asp:Button ID="Button146" runat="server" Font-Names="Calibri" Font-Size="11pt"  Text="Cancelar" Width="65px" OnClick="Button146_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                                &nbsp;&nbsp;</td>
                                ...
                                <asp:View ID="View63" runat="server" OnActivate="View63_Activate">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td style="font-weight: bold; font-size: 12pt; width: 613px; font-family: Verdana;
                                        height: 21px; background-color: darkslategray">
                                                <asp:Label ID="Label185" runat="server" Font-Names="Calibri" Font-Size="14pt" ForeColor="#FFFFCC"
                                                    Text="Reporte Cancelacion de Registros Transfermovil"></asp:Label></td>
                                        </tr>
                                        ...
                                        text-align: center">
                                                ...
                                                <table align="center">
                                                    <tr>
                                                        <td colspan="2">
                                                            <span style="font-size: 14pt; font-family: Calibri"><strong style="color: teal">Operador: </strong></span>
                                                <asp:TextBox ID="TextBox82" runat="server" Width="162px" Font-Names="Calibri"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Panel ID="Panel11" runat="server" Height="25px" Width="100%">
                                                            </asp:Panel>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Calendar ID="Calendar22" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar15_DayRender" ShowGridLines="True" Width="180px">
                                                                <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                                <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                                <SelectorStyle BackColor="#FFCC66" />
                                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                        ...
                                                        <td>
                                                            <asp:Calendar ID="Calendar23" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar16_DayRender" ShowGridLines="True" Width="180px">
                                                                <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                                <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                                <SelectorStyle BackColor="#FFCC66" />
                                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Button ID="Button148" runat="server" Font-Names="Calibri" Font-Size="11pt" Text="Aceptar" Width="65px" OnClick="Button148_Click"   />
                                                            &nbsp;
                                                            <asp:Button ID="Button149" runat="server" Font-Names="Calibri" Font-Size="11pt"  Text="Cancelar" Width="65px" OnClick="Button149_Click"  />
                                                        </td>
                                                    </tr>
                                                </table>
                                                &nbsp;&nbsp;</td>
                                ...
                                <asp:View ID="View64" runat="server" OnActivate="View64_LocaTransf_Activate">
                                    <table style="width: 100%;">
                            <tr>
                                <td style="background-color: darkslategray; text-align: center">
                                    <asp:Label ID="Label171" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="LOCALIZAR TRANSFERENCIA EXTERIOR" ToolTip="Dado los datos de la persona se localizan las transferencias realizadas a esa persona, siempre y cuando no la haya cobrado"></asp:Label>
                                </td>
                            </tr>                            
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxLabel ID="ASPxLabel2" runat="server" Font-Bold="True" Font-Size="Medium" Text="NUMERO DE IDENTIDAD">
                                    </dx:ASPxLabel>                                    
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:TextBox ID="TextBox80" runat="server" MaxLength="15" Width="120px"></asp:TextBox>                                                             
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label184" runat="server" Font-Bold="True" ForeColor="Red" Text="Label_Error" Visible="False"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <%--<dx:ASPxButton ID="ASPxButton5" runat="server" Text="ACEPTAR" OnClick="ASPxButton5_Click" ></dx:ASPxButton>--%>
                                    <asp:Button ID="ASPxButton5" runat="server" Text="ACEPTAR" OnClick="ASPxButton5_Click" Width="100px" />
                                    &nbsp;
                                    <asp:Button ID="ASPxButton6" runat="server" Text="CANCELAR" OnClick="ASPxButton6_Click" Width="100px" />
                                    <%--<dx:ASPxButton ID="ASPxButton6" runat="server" Text="CANCELAR" OnClick="ASPxButton6_Click"></dx:ASPxButton>--%>
                                </td>                                
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxGridView ID="ASPxGridView2" runat="server" Style="text-align: justify" Width="100%" KeyFieldName="REFERENCIA_ORIGEN">
                                        <SettingsBehavior AllowSort="False" />
                                        <SettingsPager EllipsisMode="None" NumericButtonCount="100" ShowDisabledButtons="False" ShowNumericButtons="False">
                                            <NextPageButton Visible="False">
                                            </NextPageButton>
                                            <PrevPageButton Visible="False">
                                            </PrevPageButton>
                                        ...
                                        <Settings ShowGroupButtons="False" ShowHeaderFilterBlankItems="False" />
                                        <SettingsText EmptyDataRow="Este cliente no tiene transferencia del exterior recibida en estos momentos. Verifique que el numero de identidad y tarjeta BT esten correctos" />
                                    </dx:ASPxGridView>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <asp:View ID="View65" runat="server" OnActivate="View65_Activate">
                                    <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td style="font-weight: bold; font-size: 12pt; width: 613px; font-family: Verdana;
                                        height: 21px; background-color: darkslategray">
                                                <asp:Label ID="Label186" runat="server" Font-Names="Calibri" Font-Size="14pt" ForeColor="#FFFFCC"
                                                    Text="Reporte Localizacion de Transferencias del Exterior"></asp:Label></td>
                                        </tr>
                                        <tr style="text-align: center">
                                            <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                        padding-left: 17px; padding-bottom: 14px; border-left: #d8d787 2px solid;
                                        ...
                                        text-align: center">
                                                ...
                                                <table align="center">
                                                    <tr>
                                                        <td colspan="2">
                                                            <span style="font-size: 14pt; font-family: Calibri"><strong style="color: teal">Operador: </strong></span>
                                                <asp:TextBox ID="TextBox83" runat="server" Width="162px" Font-Names="Calibri"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Panel ID="Panel12" runat="server" Height="25px" Width="100%">
                                                            </asp:Panel>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Calendar ID="Calendar24" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar15_DayRender" ShowGridLines="True" Width="180px">
                                                                <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                                <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                                <SelectorStyle BackColor="#FFCC66" />
                                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                        ...
                                                        <td>
                                                            <asp:Calendar ID="Calendar25" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar16_DayRender" ShowGridLines="True" Width="180px">
                                                                <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                                <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                                <SelectorStyle BackColor="#FFCC66" />
                                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Button ID="Button8" runat="server" Font-Names="Calibri" Font-Size="11pt" Text="Aceptar" Width="65px" OnClick="Button8_Click1"    />
                                                            &nbsp;
                                                            <asp:Button ID="Button150" runat="server" Font-Names="Calibri" Font-Size="11pt"  Text="Cancelar" Width="65px" OnClick="Button150_Click"   />
                                                        </td>
                                                    </tr>
                                                </table>
                                                &nbsp;&nbsp;</td>
                                ...
                                <asp:View ID="View66" runat="server" OnActivate="View66_Activate" >

                                        <table style="border-color: #008000; width: 100%;" border="0">
                                        <tr>
                                            <td style="background-color: darkslategray; text-align: center" colspan="2">
                                                <asp:Label ID="Label187" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="ACTUALIZAR DATOS CLIENTE" ToolTip="Esta opcion permite visualizar los datos del cliente, tanto en Telebanca, como en SABIC. Y a suvez, poder modificar los datos de entrada que hace el propio cliente a la operadora"></asp:Label>
                                            </td>
                                        </tr>                                                           
                                        <tr>
                                            <td colspan="2">
                                                <asp:Label ID="Label188" runat="server" Font-Bold="True" ForeColor="Black" Text="Label_Error" Visible="False"></asp:Label>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            <td colspan="2">
                                                <asp:Label ID="Label195" runat="server" Font-Bold="True" ForeColor="Black" Text="Label_Error" Visible="False"></asp:Label>
                                            </td>
                                        </tr>
                                            <tr>
                                                <td colspan="2">&nbsp;</td>
                                        ...
                                        <tr>
                                            <td id="columna_verde_sucursal" runat="server" style="background-color: darkslategray; text-align: center">
                                                <asp:Label ID="Label189" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="SUCURSAL" ToolTip="Informacion registrada en la sucursal (SABIC)"></asp:Label>
                                            </td>
                                            <td id="columna_verde_telebanca" runat="server" style="background-color: darkslategray; text-align: center">
                                                <asp:Label ID="Label190" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="TELEBANCA" ToolTip="Informacion registrada en Telebanca"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="border-color: #008000; border-style: ridge">
                                                <asp:DetailsView ID="DetailsView3" runat="server" Height="50px" Width="100%">
                                                </asp:DetailsView>                                    
                                            </td>
                                            <td style="border-style: ridge; border-color: #008000">
                                                <asp:DetailsView ID="DetailsView4" runat="server" Height="50px" Width="100%">
                                                </asp:DetailsView>                                    
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td id="columna_verde_bmovil" runat="server" style="background-color: darkslategray; text-align: center">
                                                <asp:Label ID="Label194" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="BANCA MOVIL" ToolTip="Informacion registrada en Banca movil"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <%--<dx:ASPxButton ID="ASPxButton5" runat="server" Text="ACEPTAR" OnClick="ASPxButton5_Click" ></dx:ASPxButton>--%>
                                                <asp:Button ID="Button151" runat="server" Text="ACTUALIZAR" OnClick="Button151_Click" Width="100px" Enabled="False" />
                                                &nbsp;
                                                <asp:Button ID="Button152" runat="server" Text="CANCELAR" OnClick="ASPxButton6_Click" Width="100px" />
                                                <%--<dx:ASPxButton ID="ASPxButton6" runat="server" Text="CANCELAR" OnClick="ASPxButton6_Click"></dx:ASPxButton>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="background-color: darkslategray">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                ...
                                <%--Solicitud Activacion PAN--%>
                                <asp:View ID="View67" runat="server" OnActivate="View67_Activate" >

                                        <table style="border-color: #008000; width: 100%;" border="0" align="center">
                                        <tr>
                                            <td style="background-color: darkslategray; text-align: center">
                                                <asp:Label ID="Label191" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="SOLICITUD PIN DIGITAL" 
                                                    ToolTip="El cliente solicita el pin digital de su tarjeta magnetica. 
                                                    La operadora selecciona del listado que se le muestra con todas las tarjetas magneticas pertenecientes al cliente y que estan en estado
                                                    OPERATIVA, y le genera un par de coordenadas XX-ZZ correspondientes a su tarjeta telebanca. Con el valor de estas coordenadas debe dirigirse
                                                    al cajero automatico y Activar el Pin de dicha tarjeta magnetica"></asp:Label>
                                            </td>
                                        </tr>                                                           
                                        <tr>
                                            <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <dx:ASPxGridView ID="ASPxGridView4" runat="server" Theme="Office2003Olive" Visible="False" style="text-align: center">
                                                        <SettingsBehavior AllowFocusedRow="True" />
                                                        <Settings ShowTitlePanel="True" />
                                                        <SettingsText Title="Informacion de Tarjeta Telebanca" />
                                                    </dx:ASPxGridView>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <dx:ASPxGridView ID="ASPxGridView6" runat="server" Theme="Office2003Olive" KeyFieldName="TARJETA" Visible="False" AutoGenerateColumns="False" ClientInstanceName="ASPxGridView6"
                                                        OnLoad="ASPxGridView6_Load" OnFocusedRowChanged="ASPxGridView6_FocusedRowChanged">
                                                        <Columns>
                                                            <dx:GridViewDataTextColumn Caption="TARJETA" FieldName="TARJETA" VisibleIndex="0" Width="100px">
                                                                <Settings AllowAutoFilter="True" AllowAutoFilterTextInputTimer="True" AllowHeaderFilter="False" />
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="ESTADO" FieldName="ESTADO" VisibleIndex="1" Width="30px">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="TIPO" FieldName="TIPO" VisibleIndex="2" Width="300px">
                                                            </dx:GridViewDataTextColumn>
                                                        </Columns>
                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" AllowSelectByRowClick="True" />
                                                        <Settings ShowTitlePanel="True" ShowFilterRowMenu="True" />
                                                        <SettingsText Title="Cuentas - Tarjetas del cliente" />
                                                        <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                                                    </dx:ASPxGridView>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="Button158" runat="server" Enabled="False" Font-Size="Small" OnClick="Button155_Click" Text="GENERAR" Width="100px" />
                                                    &nbsp;
                                                    <asp:Button ID="Button154" runat="server" OnClick="Button154_Click" Text="CANCELAR" Width="110px" />
                                                </td>
                                            </tr>
                                            <tr>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label192" runat="server" Font-Bold="True" ForeColor="Red" Text="Label_Error" Visible="False"></asp:Label>
                                            </td>
                                        </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <dx:ASPxGridView ID="ASPxGridView5" runat="server" Theme="Office2003Olive" Visible="False">
                                                        <SettingsPager Visible="False">
                                                        </SettingsPager>
                                                        <Settings ShowGroupButtons="False" ShowTitlePanel="True" />
                                                        <SettingsText Title="Tarjeta Activada" />
                                                    </dx:ASPxGridView>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label196" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="#009933" Text="Coordenada" ToolTip="Con el valor de estas dos coordenadas (pin de 4 digitos) usted debe ir al cajero automatico e introducirlo en la opcion ACTIVACION DE TARJETA MAGNETICA del cajero automatico " Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                        <tr>
                                            <td>
                                                <%--<asp:Button ID="Button153" runat="server" Enabled="False" OnClick="Button153_Click" Text="COORDENADAS" Width="110px" />--%>
                                                <%--<asp:Button ID="Button156" runat="server" Enabled="False" Text="GUARDAR" Width="110px" OnClick="Button156_Click" />
                                                &nbsp;--%>
                        ...
                        <asp:View ID="View68" runat="server">
                            <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                        <tr>
                                            <td style="font-weight: bold; font-size: 12pt; width: 613px; font-family: Verdana;
                                        height: 21px; background-color: darkslategray">
                                                <asp:Label ID="Label193" runat="server" Font-Names="Calibri" Font-Size="14pt" ForeColor="#FFFFCC"
                                                    Text="Reporte Solicitud Pin Digital Tarjetas Magneticas"></asp:Label></td>
                                        </tr>
                                        <tr style="text-align: center">
                                            <td align="left" style="border-right: #d8d787 2px solid; padding-right: 17px; border-top: #d8d787 2px solid;
                                        padding-left: 17px; padding-bottom: 14px; border-left: #d8d787 2px solid;
                                        ...
                                        text-align: center">
                                                ...
                                                <table align="center">
                                                    <tr>
                                                        <td colspan="2">
                                                            <span style="font-size: 14pt; font-family: Calibri"><strong style="color: teal">Operador: </strong></span>
                                                <asp:TextBox ID="TextBox84" runat="server" Width="162px" Font-Names="Calibri"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Panel ID="Panel13" runat="server" Height="25px" Width="100%">
                                                            </asp:Panel>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Calendar ID="Calendar26" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar15_DayRender" ShowGridLines="True" Width="180px">
                                                                <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                                <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                                <SelectorStyle BackColor="#FFCC66" />
                                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                        ...
                                                        <td>
                                                            <asp:Calendar ID="Calendar27" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar16_DayRender" ShowGridLines="True" Width="180px">
                                                                <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                                <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                                <SelectorStyle BackColor="#FFCC66" />
                                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Button ID="Button153" runat="server" Font-Names="Calibri" Font-Size="11pt" Text="Aceptar" Width="65px" OnClick="Button153_Click1"    />
                                                            &nbsp;
                                                            <asp:Button ID="Button155" runat="server" Font-Names="Calibri" Font-Size="11pt"  Text="Cancelar" Width="65px" OnClick="Button150_Click"   />
                                                        </td>
                                                    </tr>
                                                </table>
                                                &nbsp;&nbsp;</td>
                        ...
                        <asp:View ID="View70" runat="server" OnActivate="View70_Activate">
                            <div style="text-align: center">
                                <table cellpadding="0" cellspacing="0" width="100%" align="center">
                                    <tr>
                                        <td style="background-color: darkslategray; text-align: center">
                                            <asp:Label ID="Label198" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="14pt" ForeColor="Lime" Text="BUSQUEDA EN BANCA MOVIL" ToolTip="El tipo o tasa de cambio entre dos divisas es la tasa o relación de proporción que existe entre el valor de una y la otra. Dicha tasa es un indicador que expresa cuántas unidades de una divisa se necesitan para obtener una unidad de la otra."></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table style="width: 100%; text-align: center" align="center">
                                    <tr style="text-align: center">                                        
                                        <td colspan="2" style="text-align: right">
                                            <asp:RadioButtonList ID="RadioButtonList20" runat="server" AutoPostBack="True" BackColor="#CCFF99" OnSelectedIndexChanged="RadioButtonList20_SelectedIndexChanged" RepeatDirection="Horizontal" style="text-align: center">
                                            </asp:RadioButtonList>
                                        </td>                                       
                                    </tr>
                                    <tr style="text-align: center">
                                    ...
                                    <tr style="align-content:center">
                                        <td colspan="2">
                                            <asp:CheckBox ID="CheckBox6" runat="server" Text="Rango de Fecha" AutoPostBack="True" OnCheckedChanged="CheckBox6_CheckedChanged" />
                                        </td>
                                    </tr>
                                    <tr style="align-content:center">
                                        <td colspan="2">
                                            <table align="center">
                                                <tr>
                                                    <td><dx:ASPxLabel ID="ASPxLabel4_desde" runat="server" Text="DESDE" Font-Size="14pt"></dx:ASPxLabel></td>
                                                    <td><dx:ASPxLabel ID="ASPxLabel5_hasta" runat="server" Text="HASTA" Font-Size="14pt"></dx:ASPxLabel></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Calendar ID="Calendar28" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar15_DayRender" ShowGridLines="True" Width="180px" Visible="False">
                                                            <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                            <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                            <SelectorStyle BackColor="#FFCC66" />
                                                            <OtherMonthDayStyle ForeColor="#CC9966" />
                                                    ...
                                                    <td>
                                                        <asp:Calendar ID="Calendar29" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar16_DayRender" ShowGridLines="True" Width="180px" Visible="False">
                                                            <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                            <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                            <SelectorStyle BackColor="#FFCC66" />
                                                            <OtherMonthDayStyle ForeColor="#CC9966" />
                                    ...
                                    <tr>
                                        <td style="text-align: right">
                                            <dx:ASPxButton ID="ASPxButton9" runat="server" OnClick="ASPxButton9_Click" Text="ACEPTAR">
                                                <ClientSideEvents Click="function(s, e) {
                                        ...
                                        <td style="text-align: left">
                                            <dx:ASPxButton ID="ASPxButton10" runat="server" Text="CANCELAR" OnClick="ASPxButton10_Click">
                                            </dx:ASPxButton>
                                        </td>
                                    </tr>
                                    <tr style="align-content:center">
                                    ...
                                    <tr style="align-content:center">
                                        <td colspan="2" style="background-color: darkslategray">
                                            <asp:Label ID="Label197" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="10pt" ForeColor="Lime" Text="INFORMACION DEL REGISTRO EN BANCA MOVIL" ></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="align-content:center">
                                        <td colspan="2">
                                            <table id="tabla_info_bancamovil" runat="server" align="center" style="width: 300px; text-align: center;">
                                                <tr>
                                                    <td class="auto-style2" style="width: 120px">
                                                        <dx:ASPxLabel ID="ASPxLabel7" runat="server" Font-Bold="True" Text="TELEBANCA: ">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="auto-style2" style="width: 120px">
                                                        <dx:ASPxLabel ID="ASPxLabel9" runat="server" Font-Bold="True" Text="MOVIL: ">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td class="auto-style3">
                                                ...
                                                <tr>
                                                    <td class="auto-style2" style="width: 120px">
                                                        <dx:ASPxLabel ID="ASPxLabel11" runat="server" Font-Bold="True" Text="NUM IDENTIDAD: ">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td class="auto-style3">
                                                ...
                                                <tr>
                                                    <td class="auto-style2" style="width: 120px">
                                                        <dx:ASPxLabel ID="ASPxLabel15" runat="server" Font-Bold="True" Text="COD PAIS: ">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td class="auto-style3">
                                                ...
                                                <tr>
                                                    <td class="auto-style2" style="width: 120px">
                                                        <dx:ASPxLabel ID="ASPxLabel13" runat="server" Font-Bold="True" Text="TIPO IDENTIF: ">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td class="auto-style3">
                                                        <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="ASPxLabel">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style2" style="width: 120px">
                                                        <dx:ASPxLabel ID="ASPxLabel17" runat="server" Font-Bold="True" Text="ESTADO: ">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td class="auto-style3">
                                                        <dx:ASPxLabel ID="ASPxLabel18" runat="server" Text="ASPxLabel">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr style="align-content:center">
                                        <td colspan="2">
                                            <dx:ASPxGridView ID="ASPxGridView11" runat="server" style="text-align: center" Visible="False" Width="100%">
                                                <Settings ShowTitlePanel="True" />
                                                <SettingsText EmptyDataRow="No tiene informacion de registro en Banca Movil" />
                                            </dx:ASPxGridView>
                                        </td>
                                    </tr>
                                    <tr style="align-content:center">
                                    ...
                                    <tr style="align-content:center">
                                        <td colspan="2">
                                            <dx:ASPxGridView ID="ASPxGridView9" runat="server" style="text-align: center" Width="100%" Visible="False">
                                                <Settings ShowTitlePanel="True" />
                                                <SettingsText EmptyDataRow="No tiene cuentas asociadas en Sabic Sucursal Electronica" />
                                            </dx:ASPxGridView>
                                        </td>
                                    </tr>
                                    <tr style="align-content:center">
                                    ...
                                    <tr style="align-content:center">
                                        <td colspan="2">
                                            <dx:ASPxGridView ID="ASPxGridView10" runat="server" style="text-align: center" Visible="False" Width="100%">
                                                <Settings ShowTitlePanel="True" />
                                            </dx:ASPxGridView>
                                        </td>
                                    </tr>
