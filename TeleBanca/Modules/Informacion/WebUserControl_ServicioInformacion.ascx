...
<table width="950px">
            ...
            <asp:MultiView ID="MVwInformacion" runat="server" ActiveViewIndex="0">
                ...
                <asp:View ID="View2" runat="server">
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td style="border: 2px solid #d8d787; padding: 14px 17px; width: 595px;
    ...
    Tipo de Consulta</strong></span></td>
                ...
                <asp:View ID="View35" runat="server" OnActivate="View35_Activate">
                    <div style="text-align: center">
                                ...
                                <table style="width: 100%; text-align: center" align="center">
                                    ...
                                    <tr style="align-content:center">
                                        <td colspan="2">
                                            <asp:CheckBox ID="CheckBox20" runat="server" Text="Rango de Fecha" AutoPostBack="True" OnCheckedChanged="CheckBox20_CheckedChanged" />
                                        </td>
                                    </tr>
                                    <tr style="align-content:center">
                                        <td colspan="2">
                                            <table align="center">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Calendar ID="Calendar28" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar3_DayRender" ShowGridLines="True" Width="180px" Visible="False">
                                                            <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                            <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                            <SelectorStyle BackColor="#FFCC66" />
                                                            <OtherMonthDayStyle ForeColor="#CC9966" />
                                                    ...
                                                    <td>
                                                        <asp:Calendar ID="Calendar29" runat="server" SelectedDate="2007-07-12" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="150px" OnDayRender="Calendar4_DayRender" ShowGridLines="True" Width="180px" Visible="False">
                                                            <SelectedDayStyle BackColor="#FFC080" Font-Bold="True" />
                                                            <TodayDayStyle BackColor="White" ForeColor="Black" BorderWidth="2px" />
                                                            <SelectorStyle BackColor="#FFCC66" />
                                                            <OtherMonthDayStyle ForeColor="#CC9966" />
