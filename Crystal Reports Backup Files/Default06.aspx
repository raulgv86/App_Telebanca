...
<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Default06.aspx.cs" Inherits="_Default" %>
...
<body style="padding-right: 0px; padding-left: 0px; padding-bottom: 0px; margin: 0px; clip: rect(auto auto auto auto); padding-top: 0px; text-align: center;">
    ...
    <div>
        ...
        <table>
            <tr>
                <td style="text-align: center">
                    <asp:Panel ID="Panel1" runat="server" BackImageUrl="~/Images/Imagenes/TarjetaTB06.png"
                        ...
                        <br />
                        &nbsp;&nbsp;
            <asp:Login ID="Login06" runat="server" FailureText="Usuario o contraseña no válidos. Intente otra vez."
                LoginButtonText="Acceder" OnAuthenticate="Login06_Authenticate" PasswordLabelText="Contraseña"
                RememberMeText="Recordar contraseña." TitleText="" UserNameLabelText="Usuario" PasswordRequiredErrorMessage="*" UserNameRequiredErrorMessage="*" DestinationPageUrl="~/Main06.aspx" DisplayRememberMe="False" Font-Bold="True" Font-Names="Calibri" EnableTheming="True" ForeColor="#404040" Width="300px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName"
                                                ErrorMessage="*" Font-Names="Calibri" ToolTip="*" ValidationGroup="Login06">*</asp:RequiredFieldValidator></td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                    ...
                                    <tr>
                                        <td align="right" colspan="2" style="height: 27px">
                                            <asp:Button ID="LoginButton" runat="server" CommandName="Login" Font-Bold="True"
                                                Font-Names="Calibri" Font-Size="11pt" ForeColor="Black" Text="Acceder" ValidationGroup="Login06" OnClick="LoginButton_Click" />
                                        </td>
        ...
        <iframe frameborder="0" width="100%" height="200px" src="HTML/Buen_Trato06.htm" style="width: 100%; height: 250px" scrolling="yes"></iframe>
