<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Main12.aspx.cs" Inherits="Default2" Async="true" %>
...
<div id="art-page-background-glare">
    ...
    <form id="form1" runat="server">                
        <div style="background-color: #006666; text-align: center">
                <table style="width: 794px; background-color: #ffffff;">
                <tr>
                    <td colspan="4" style="height: 164px">
                        <img id="IMG1" alt="" src="Images/Imagenes/telebanca_portada.png" height="200" width="850" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right; width: 130px;">
                        <asp:ImageButton ID="ImageButton6" runat="server" Height="20px" ImageAlign="Right"
                            ImageUrl="~/Images/Imagenes/icono cerrar seción.jpg" OnClick="ImageButton6_Click" /><asp:LinkButton ID="LinkButton4" runat="server" Font-Bold="True" Font-Names="Calibri"
                            Font-Overline="False" Font-Size="11pt" ForeColor="#00C000" OnClick="LinkButton4_Click" CausesValidation="False" Width="100px">Cerrar Sesión</asp:LinkButton></td>
                </tr>
                <tr>
